...
class workTimeSearch extends React.Component {
  ...
  componentDidMount() {
    ...
    this.searchWorkTime(
      publicUtils.converToLocalTime(ThisYear + "01", false),
      publicUtils.converToLocalTime(ThisYear + "12", false)
    );
  }
  // onchange
  valueChange = (event) => {
  ...
  searchWorkTime = (yearAndMonth1, yearAndMonth2) => {
    let workTimeModel = {
      yearAndMonth1:
        yearAndMonth1 == ""
          ? publicUtils.formateDate(this.state.yearAndMonth1, false)
          : publicUtils.formateDate(yearAndMonth1, false),
      yearAndMonth2:
        yearAndMonth2 == ""
          ? publicUtils.formateDate(this.state.yearAndMonth2, false)
          : publicUtils.formateDate(yearAndMonth2, false),
    };
    axios
      .post(
        this.state.serverIP + "workTimeSearch/selectWorkTime",
        workTimeModel
      )
